...
<head>
    ...
    <title>Mi Panel - Inmobiliaria UTS</title>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted small">Explorar propiedades</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted small">Propiedades guardadas</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted small">Visitas programadas</p>
                                </div>
                            </div>
                        </div>
                    </div>
