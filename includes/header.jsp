            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#propiedades">
                        <i class="bi bi-house-heart me-1"></i> Propiedades
                    </a>
                </li>
            </ul>

            <div class="d-flex gap-2">
                <a href="${pageContext.request.contextPath}/LoginServlet" class="btn btn-outline-light btn-nav">
                    <i class="bi bi-box-arrow-in-right me-1"></i> Iniciar Sesion
                </a>
                <a href="${pageContext.request.contextPath}/RegistroServlet" class="btn btn-gold btn-nav">
