...
<head>
    ...
    <title>Panel Administrador - Inmobiliaria UTS</title>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted small">Gestionar cuentas y roles</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-2">Propiedades</h5>
                                    <p class="text-muted small">Administrar inmuebles</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted small">Estadisticas del sistema</p>
                                </div>
                            </div>
                        </div>
                    </div>
